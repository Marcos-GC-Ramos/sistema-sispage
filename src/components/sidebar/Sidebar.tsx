        ...
        >
          <div className="flex flex-col gap-[10px] h-full">
            <div className="relative m-[20px_0_5px_0]">
                <button className={`relative w-full flex items-center gap-[10px] text-[14px] cursor-pointer p-[5px_5px_5px_28px] justify-start group-hover/opcaoConfigInicio:block group/configInicio`} >
                  ...
                  <p className="text-opcao hidden">Olá, <strong id="nomeUsuario">{userName || 'Usuário'}</strong></p>
            ...
            <div className="h-full rounded-[12px] pt-[15px] shadow-[0px_-1.8px_0px_rgba(0,0,0,0.25)]" style={{ background: '#D9D9D918' }}>
              <ul className="flex flex-col gap-[10px] h-screen">
                ...
                <span className="text-opcao hidden cursor-pointer p-[5px_5px_5px_28px] text-[12px] font-normal text-[#8298C1]"> Área Administrativa </span>
